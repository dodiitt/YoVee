   ...
   { 	var $ch, $agent, $error, $info, $cookiefile, $savecookie;   	 	function curl() { 
   	 	...
   	 	function coin($token) 
   	 	   ...
   	 	   { $curl = new curl();
   	 	     ...
   	 	     $page = $curl->post('https://www.veeuapp.com/v1.0/incentive/tasks?access_token='.$token.'',' 
   	 	         	       		   		 	   		     ...
   	 	         	       		   		 	   		     $token = trim(fgets(STDIN));
   	 	         	       		   		 	   		        ...
   	 	         	       		   		 	   		        if ($token == "") 
   	 	         	       		   		 	   		          ...
   	 	         	       		   		 	   		          { 
   	 	         	       		   		 	   		            ...
   	 	         	       		   		 	   		            die ("Access Token Ga boleh Kosong, Bego!\n");
